...
class OtherUserFavorRecipesProvider  with ChangeNotifier implements RecipesProvider {
  List<Recipe>? _list;

  late int userId;

  OtherUserFavorRecipesProvider(this.userId);
  ...
  Future<void> fetchRecipes() async {
    final res = await UserService.getUserFavorRecipe(userId);
    if(!res.isSuccess()) {
